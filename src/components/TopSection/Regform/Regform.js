...
export default class Regform extends Component {
    ...
    render() {
        ...
        if (this.props.syncState.step <= 3) {
            return (
                <div className={"Regform regform" + (this.props.class ? this.props.class : '')} ref={this.setTextInputRef}>

                    <div className='inner component-form-registration'>
                        <div className={'form-wrapper one form__wrapper' + ((this.props.syncState.step > 1) ? ' step' : '')}>
                            <div className="form__block">
                                <div className="form__field-row">
                                    {this.inputs.map(input =>
                                        <div className="form__field-group form__field-group-w50 form__field-type" key={input}>
                                            <input
                                ...
                                <div className="form__field-row">
                                    <div className="form__field-group form__field-group-w100 form__field-type">
                                        <input type="email" name="email" placeholder={version.email} value={this.props.syncState.form.email} onChange={e => this.updateValue(e.target.value, 'email')}/>
